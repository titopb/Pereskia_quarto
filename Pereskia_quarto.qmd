...
CAM plants have adapted to water-limited conditions by fixing $CO_2$ at night when the stomata are open, storing it as organic acids, and releasing it during the day when the stomata are closed [@luttge_ecophysiology_2004]. This obligate CAM is characterized by the strict separation of day and night metabolic activities. In contrast, CAM-idling, often seen under extreme drought conditions, involves nocturnal acid accumulation without daytime decarboxylation, essentially a "survival mode". CAM-cycling, exhibits nocturnal $CO_2$ uptake with daytime stomatal closure but without significant organic acid fluctuations. Finally, weak CAM, or facultative CAM allows a dynamic switch between $C_3$ and CAM modes depending on environmental conditions [@winter_ecophysiology_2019, @winter_facultative_2014].

#Revisar conceitos de CAM idling, cycling etc...
